...
exports.handler = async function(event, context) {
    ...
    try {
        ...
        const response = await fetch(url, {
            ...
            body: JSON.stringify({
                contents: [{
                    parts: [{ text: You are a helpful, professional customer service chatbot for 'Rozix' (a business/agency website). Answer the user's question politely and concisely in Urdu/Roman-Urdu or English depending on how they ask. User asks: ${message} }]
                }]
            })
        });
